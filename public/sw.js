const CACHE='job-radar-v6';
const SHELL=['./','./index.html','./styles.css','./fixed.css','./new-jobs.css','./fresh-highlights.css','./readable-ui.css','./app.js','./new-jobs.js','./pwa-install.js','./manifest.webmanifest','./icons/icon.svg','./icons/icon-maskable.svg'];
