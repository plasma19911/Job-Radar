...
const SHELL=['./','./index.html','./styles.css','./fixed.css','./new-jobs.css','./fresh-highlights.css','./readable-ui.css','./polish.css','./app.js','./new-jobs.js','./favorite-store.js','./pwa-install.js','./manifest.webmanifest','./icons/icon.svg','./icons/icon-maskable.svg'];
