...
const OFFICE=/(sachbearbeit|buro|office|backoffice|back office|verwaltung|verwaltungs|administrat|assistenz|assistant|sekret|empfang|rezeption|reception|kundenservice|customer service|customer support|kundenbetreu|servicecenter|service center|call center|telefon|disponent|disposition|koordinator|koordination|buchhalt|accounting|finance|finanz|controlling|personal|human resources|\bhr\b|recruit|payroll|lohn|gehalt|einkauf|procurement|vertriebsinnendienst|inside sales|sales support|auftragssachbearbeit|auftragsbearbeit|datenpflege|data entry|datenerfass|stammdaten|support|helpdesk|help desk|it support|software|developer|entwickler|programm|digital|online|content|marketing|kommunikation|projektassist|projektkoordination|projektmanagement|project management|bank|versicherung|versicherungs|immobilienverwaltung|property management|termin|planung|planer|document control|dokumentation|qualitatsmanagement|compliance|legal|recht|e commerce|ecommerce|crm|sap|excel|microsoft office|kaufmann|kaufmannisch|kauffrau)/i;
const PHYSICAL=/(lager|kommission|packer|verpacker|produktion|produktionsmitarbeiter|fertigung|montage|monteur|reinigung|reiniger|pflegefach|pflegehelfer|altenpflege|krankenpflege|erzieher|fahrer|fahrerin|zusteller|kurier|lieferfahrer|handwerker|elektriker|mechaniker|mechatroniker|schlosser|schweisser|installateur|techniker im aussendienst|bauarbeiter|baustelle|tiefbau|hochbau|maurer|dachdecker|gartner|hausmeister|security|sicherheitsmitarbeiter|wachschutz|kuche|koch|kochin|backer|fleischer|metzger|servicekraft|kellner|verkaufer|kassierer|warenverraum|logistikmitarbeiter|pfortner)/i;
